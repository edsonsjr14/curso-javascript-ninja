(function(){
    ...
    */
    ...
    brasil.splice(0, 0, 'Goias', 'Mato Grosso', 'Bahia');
    console.log(brasil.toString());
    ...
    */
    ...
    var msg = 'Sim, todos os estados tem mais de 7 Letras!';
    brasil.some(function(item){
        if(item.length < 7) msg = 'Nem todos os estados tem mais de 7 letras!';
    });
    console.log(msg);
