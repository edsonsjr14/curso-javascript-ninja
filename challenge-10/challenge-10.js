(function(){
	...
	*/
	function calculator(operador){
		return isOperatorValid(operador) ? function(num1, num2){
			return (typeof num1 === 'number' && typeof num2 === 'number') ? operation[operador](num1, num2) : false;
		} : false;
	}
	...
	*/
	operationSignal = '$';
	var sum = calculator(operationSignal);
	console.log(sum ? sum(number1, number2) : showErrorMessage(operationSignal));
